package org.sunjian.graphdatabaseservice.controller.restful.dto;

import org.springframework.data.domain.Page;
import org.springframework.validation.BindingResult;
import org.sunjian.graphdatabaseservice.controller.restful.util.JsonUtil;
...
public class CommonResult {
     ...
     * 带信息的失败提示信息
     */
    public CommonResult failed(String data) {
        this.code = FAILED;
        this.message = "操作失败";
        this.data =data;
        return this;
